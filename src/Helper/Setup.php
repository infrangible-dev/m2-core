...
class Setup
{
    ...
    protected function addEntityAttributeType(SetupInterface $setup, string $entityTypeTableName, string $attributeType)
    {
        ...
        if (!$connection->isTableExists($entityAttributeTypeTableName)) {
            ...
            if ($setup instanceof SchemaSetupInterface) {
                ...
                $entityAttributeTypeTable->addForeignKey($setup->getFkName($entityAttributeTypeTableName,
                    'attribute_id', $eavAttributeTableName, 'attribute_id'), 'attribute_id', $eavAttributeTableName,
                    'attribute_id', Table::ACTION_CASCADE);
    ...
    {
        return $this->addAttributeToSetAndGroup($setup, Product::ENTITY, $attributeCode, $attributeSetName,
            $attributeGroupName, $attributeSortOrder);
    }
        ...
        if (is_array($attributeSetData)) {
            ...
            if ($attributeSetId) {
                ...
                if (is_array($attributeGroupData)) {
                    ...
                    if ($attributeGroupId) {
                        $setup->addAttributeToGroup($entityTypeId, $attributeSetId, $attributeGroupId, $attributeId,
                            $attributeSortOrder);
